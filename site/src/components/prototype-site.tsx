"use client";
import { saveDraft, clearDraft } from "@/lib/drafts";
...
export function PrototypeSite({authenticated,initialPackage,userId}:{authenticated:boolean;initialPackage:string;userId:string|null}){
